...
export function HeroImageField({ name, label, defaultValue = "" }: HeroImageFieldProps) {
  ...
  return (
    ...
    >
      ...
      <input
        ...
        placeholder="Paste image URL or use drag-and-drop"
        style={{
          width: "100%",
          padding: "12px 14px",
          borderRadius: 14,
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
        ...
        >
          Choose file
          <input type="file" accept="image/*" hidden onChange={(event) => void onFileChange(event)} />
        </label>
        <button
          type="button"
          onClick={() => {
